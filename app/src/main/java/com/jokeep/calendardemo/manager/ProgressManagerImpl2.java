...
import com.jokeep.calendardemo.models.StubViewHolder;
...
public class ProgressManagerImpl2 extends ProgressManager2 {
    ...
    public ProgressManagerImpl2(@NonNull MyCollaspCalendarView calendarView, int activeWeek, boolean fromMonth) {
