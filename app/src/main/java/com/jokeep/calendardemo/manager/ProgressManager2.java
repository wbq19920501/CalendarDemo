package com.jokeep.calendardemo.manager;

import android.support.annotation.NonNull;
import android.widget.LinearLayout;

import com.jokeep.calendardemo.CollapseCalendarView;
import com.jokeep.calendardemo.models.AbstractViewHolder;
import com.jokeep.calendardemo.models.SizeViewHolder;
import com.jokeep.calendardemo.view.MyCollaspCalendarView;


/**
 * Created by Blaz Solar on 17/04/14.
 */
public abstract class ProgressManager2 {

	public static final String TAG = "ProgressManager";

    @NonNull protected MyCollaspCalendarView mCalendarView;
    ...
    protected ProgressManager2(@NonNull MyCollaspCalendarView calendarView, int activeWeek, boolean fromMonth) {
